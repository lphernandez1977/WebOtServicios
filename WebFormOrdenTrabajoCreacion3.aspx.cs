...
{
    public partial class WebFormOrdenTrabajoCreacion3 : System.Web.UI.Page
    {
        ...
        protected void BtnOt_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in GvDatos.Rows)
            {
                ...
                if (check.Checked == true)
                {
                    ...
                    //cabecera ot
                    //_ent_Tb_OT_Encabezado.fecha_creacion_ot = DateTime.Now;//DateTime.Parse(_lgn_FechaHoraServer.Selecciona_FechaHoraServer(), "dd/MM/yyyy H:mm:ss", null);
                    ...
                    Response.Redirect("WebFormOrdenTrabajoCreacion3.aspx");
                }
