<%@ Page Title="" Language="C#" MasterPageFile="~/e-MAC.Master" AutoEventWireup="true" CodeBehind="WebFormMantenedorPersonal.aspx.cs" Inherits="WebOtServicios.WebFormMantenedorPersonal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-header">
        <h1 class="text-center"><small>Mantenedor Personal</small></h1>
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-3">
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <label for="full_name_id" class="control-label">Rut Tecnico</label>
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-3">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>
                    <label for="full_name_id" class="control-label">Nombre Tecnico</label>
                    <div class="form-group">
                        <!-- Full Name -->
                        <asp:TextBox ID="TxtNombreTec" Font-Names="TxtNombreTec" CssClass="form-control" MaxLength="50" runat="server" placeholder="Nombre"></asp:TextBox>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-3">
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    <label for="full_name_id" class="control-label">Apellido Tecnico</label>
                    <div class="form-group">
                        <!-- Full Name -->
                        <asp:TextBox ID="TextApeTec" Font-Names="TxtNombreTec" CssClass="form-control" MaxLength="50" runat="server" placeholder="Apellido"></asp:TextBox>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                <ContentTemplate>
                    <div class="form-inline">
                        ...
                        <label for="full_name_id" class="control-label">Cargo</label>
                        <asp:DropDownList ID="CboCargo" CssClass="form-control" runat="server" Width="150px"></asp:DropDownList>
                        <label for="full_name_id" class="control-label">Contraseña</label>
                        <asp:TextBox ID="TxtPass" Font-Names="Dv" CssClass="form-control" MaxLength="4" runat="server" placeholder="Contraseña" Width="100px"></asp:TextBox>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="GvDatos" runat="server"
                        DataKeyNames="rut_personal,nom_empleado,ape_empleado,contrasenia,cod_cargo"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Pass"
                                DataField="contrasenia"
                                ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="80px">
                                <HeaderStyle Width="80px" />
                                <ItemStyle HorizontalAlign="Left" />
